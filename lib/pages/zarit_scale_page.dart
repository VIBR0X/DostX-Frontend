                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          width:
                              (345 / 414) * MediaQuery.of(context).size.width,
                          child: Text(
                            translations[LanguageManager().currentLanguage]![
                        ...
                        SizedBox(
                          height: (18 / 869) * screenHeight(context),
                        ),
                        ZaritTestQuestions(
                          question:
                              translations[LanguageManager().currentLanguage]![
                        ...
                        // ZaritTestQuestions(question: translations[LanguageManager().currentLanguage]!['feel_embarrassed_of_relative_behavior']!),
                        SizedBox(
                          height: (35 / 869) * screenHeight(context),
                        ),
                        SizedBox(
