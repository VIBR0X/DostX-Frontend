...
import 'globals.dart ';
class ZerithScalePage extends StatefulWidget {
  const ZerithScalePage({super.key});

  @override
  State<ZerithScalePage> createState() => _ZerithScalePageState();
}

class _ZerithScalePageState extends State<ZerithScalePage> {
  String? stressed;
  String? embarrassed;
  @override
